...
/** An unreadable or corrupt JSON file; the caller must not overwrite it with defaults. */
...
/** A failed atomic replacement, with the original file left in place. */
...
/** Read optional JSON, distinguishing missing files from corruption and permission errors. */
...
/**
 * Atomically replace a private state file, using a unique temporary file per call.
 * Callers still own serialization of read-modify-write operations and save ordering.
 */

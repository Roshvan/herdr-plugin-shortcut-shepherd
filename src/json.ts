...
/** Refine strings at external boundaries, including Node's unknown error fields. */
// oxlint-disable-next-line anti-slop/no-unknown-parameters -- External error and protocol values are parsed at this boundary.

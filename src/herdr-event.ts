...
export function workspaceId(raw: string): WorkspaceId {
  // SAFETY: WorkspaceId is a nominal brand over the id string Herdr sent; it carries no further runtime invariant.
  return raw as WorkspaceId;
}

export function tabId(raw: string): TabId {
  // SAFETY: TabId is a nominal brand over the id string Herdr sent; it carries no further runtime invariant.
  return raw as TabId;
}

export function paneId(raw: string): PaneId {
  // SAFETY: PaneId is a nominal brand over the id string Herdr sent; it carries no further runtime invariant.
...
export type PaneRect = { readonly paneId: PaneId; readonly rect: Rect };
...
export function parseWorkspaceRecord(value: JsonValue | undefined): WorkspaceRecord | undefined {
...
export function parseTabRecord(value: JsonValue | undefined): TabRecord | undefined {
  if (!isJsonObject(value)) return undefined;
...
export function parsePaneRecord(value: JsonValue | undefined): PaneRecord | undefined {
  if (!isJsonObject(value)) return undefined;
...
export function parseTabLayout(value: JsonValue | undefined): TabLayout | undefined {
  if (!isJsonObject(value)) return undefined;
  const workspace = stringField(value, "workspace_id");
  const tab = stringField(value, "tab_id");
...
export function parseHerdrEventData(eventType: string, data: JsonObject): Result<HerdrEvent, MalformedHerdrEvent | IgnoredHerdrEvent> {
